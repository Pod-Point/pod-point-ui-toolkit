	...
	dom.whenReady(function () {
	    (0, _moduleLoader2.default)({
	        domModules: (0, _domModuleLoader2.default)({
	            toggleElement: _index.toggleElement,
	            accordion: _index.accordion,
	            typeahead: _index.typeahead
	        })
	    });
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.typeahead = exports.toggleElement = exports.accordion = undefined;
	...
	var _toggleElement = __webpack_require__(11);
	...
	exports.toggleElement = _toggleElement2.default;
